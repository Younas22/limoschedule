...
@section('content')
    ...
    <div class="flex items-center justify-between mb-6">
        <div>
            ...
            <p class="text-gray-500 text-sm mt-1">Tamam blog posts manage karein</p>
        </div>
    ...
    <div class="bg-white rounded-xl shadow-sm border border-gray-100 overflow-hidden">
        @if($blogs->isEmpty())
            <div class="text-center py-16 text-gray-400">
                ...
                <p class="text-sm">Koi blog post nahi mila</p>
                <a href="{{ route('admin.blogs.create') }}" class="mt-3 inline-block text-yellow-500 hover:underline text-sm">Pehla post likhein</a>
            </div>
        @else
                        ...
                        <tr class="hover:bg-gray-50 transition">
                            ...
                            <td class="px-5 py-3">
                                <div class="flex items-center gap-3">
                                    ...
                                    <form method="POST" action="{{ route('admin.blogs.destroy', $blog) }}" onsubmit="return confirm('Yeh blog post delete karein?')">
                                        @csrf
                                        @method('DELETE')
